...
<html lang="pt-br">
	<head>
		...
		<link href="app/assets/css/estilo2.css" rel="stylesheet" type="text/css">
	
		<title>Máximo Qi. | <?php echo $title; ?></title>
    ...
    <div class="geral">
		<header>
			...
			<section id="menu-soc">
				...
				<div id="soc-topo">
					<a href="https://www.facebook.com/maximoqi" target="_blank"><img src="app/assets/img/facebook.png"></a>
					<a href="https://twitter.com/cursosmaximoqi" target="_blank"><img src="app/assets/img/twitter.png"></a>
					<a href="https://plus.google.com/118332567317240989431" target="_blank"><img src="app/assets/img/google-plus.png"></a>
					<span class="moveis">
						<a href="whatsapp://send?text=Nosso%20Whatsapp%20é:(21)98127-3958" target="_blank"><img src="app/assets/img/whatsapp.png"></a>
						<a href="https://www.instagram.com/maximoqi/" target="_blank"><img src="app/assets/img/instagram.png"></a>
					</span>
					<a href="https://www.youtube.com/channel/UCitJSKBoD1Zk3tmwhkQPaeA" target="_blank"><img src="app/assets/img/youtube.png"></a>
					<a href="https://www.linkedin.com/company/m%C3%A1ximo-qi" target="_blank"><img src="app/assets/img/linkedin.png"></a>
				</div>
			</section>
				...
				<li ><a href="./cursos">Cursos </a><span class="seta-baixo"></span>
					<ul class="submenu">
						<li><a href="">Concursos </a><span></span> 
							<ul class="submenu2">
                            	<li><a href="../cursos/concursosAbertos/inss.html">INSS</a></li>
								<li><a href="../cursos/concursosAbertos/ibge.html">IBGE</a></li>
							</ul>
						</li> 
						<li><a href="">Reforço escolar </a><span></span>
                        	<ul class="submenu2">
								<li><a href="../cursos/reforcoEscolar/diario.html">Reforço diário </a></li>
								<li><a href="../cursos/reforcoEscolar/particular.html">Aula particular</a></li>
						   	</ul>
                        </li> 
